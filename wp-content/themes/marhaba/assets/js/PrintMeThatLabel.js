...
(function()
{
    ...
    function onload()
    {
        ...
        var print_delivery_note = document.getElementById('print_delivery_note');
        var print_gift_message = document.getElementById('print_gift_message');
        var print_delivery_address = document.getElementById('print_delivery_address');
        ...
        print_delivery_note.onclick = function()
        {
            try
            {
                ...
                var text =  document.getElementById('delivery_note_txt').innerHTML;
        ...
        print_gift_message.onclick = function()
        {
            ...
            try
            {
                ...
                var text =  document.getElementById('gift_message_area').innerHTML;
                 text = text.replace(/.{50,50} /g, "$&\n");
                 text = text.replace(/&amp;/g, '&');
               // alert(text);
                var printer = printers[settings.currentPrinterName];
        ...
        print_delivery_address.onclick = function() {
            try
            {
                //printButton.disabled = true;

                settings.currentPrinterName = printersComboBox.value;
                var textTextArea = document.getElementById('del_id_name');
                var print_text = textTextArea.innerHTML;
                var del_address = document.getElementById('del_address').innerHTML.replace("&amp;","&");
                text = print_text+"\n"+del_address.replace("&amp;","&");
